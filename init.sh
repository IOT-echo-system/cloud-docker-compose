...
mkdir -p ./bff-mqtt/data ./bff-mqtt/config ./bff-mqtt/log
touch ./bff-mqtt/config/mosquitto.conf
touch ./bff-mqtt/config/acl_file.conf
touch ./bff-mqtt/config/pwfile
sudo echo 'persistence true
persistence_location /mosquitto/data
user mosquitto
listener 1883
...
connection_messages true
acl_file /mosquitto/config/acl_file.conf
password_file /mosquitto/config/pwfile' > ./bff-mqtt/config/mosquitto.conf
